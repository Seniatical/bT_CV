...
async def twilight(ctx: commands.Context, source: str = None, *flags, **priv) -> Any:
...
COMMAND_CALLBACK = twilight
COMMAND_NAME = "twilight"
COMMAND_USAGE = """
ct!filter twilight [src...]?
ct!filter twilight [src...]? [--flags]
"""
COMMAND_DESCRIPTION = "Applies TWILIGHT color map to an image!"
