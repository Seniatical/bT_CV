...
async def autumn(ctx: commands.Context, source: str = None, *flags, **priv) -> Any:
    ...
    if file.is_image:
        embed = discord.Embed(title="Autumn image", colour=discord.Colour.red())
        ...
        m = await ctx.reply(content="Autumn image data []".format(file.export_as), file=file)
...
COMMAND_CALLBACK = autumn
COMMAND_NAME = "autumn"
COMMAND_USAGE = """
ct!filter autumn [src...]?
ct!filter autumn [src...]? [--flags]
"""
COMMAND_DESCRIPTION = "Applies AUTUMN colour map to image!"
