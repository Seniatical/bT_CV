...
from api.effects import flip as F
from core.com_par import parser
from binascii import Error


async def flip(ctx: commands.Context, source: str = None, *flags, **priv) -> Any:
    ...
    if file.is_image:
        embed = discord.Embed(title="Flipped image", colour=discord.Colour.red())
...
COMMAND_CALLBACK = flip
COMMAND_NAME = "flip"
COMMAND_USAGE = """
ct!filter flip [src...]?
ct!filter flip [src...]? [--flags]
"""
COMMAND_DESCRIPTION = "Flips an image!"
