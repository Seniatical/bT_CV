...
async def pixelate(ctx: commands.Context, source: str = None, *flags, **priv) -> Any:
...
COMMAND_CALLBACK = pixelate
COMMAND_NAME = "pixelate"
COMMAND_USAGE = """
ct!filter pixelate [src...]?
ct!filter pixelate [src...]? [--flags]
"""
COMMAND_DESCRIPTION = "Pixelates an image!"
