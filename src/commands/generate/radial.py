...
COMMAND_CALLBACK = radial_gradient
COMMAND_NAME = "radial_gradient"
COMMAND_USAGE = """
ct!generate radial_gradient
"""
COMMAND_ALIASES = ["rg", "r_gradient", "rad_grad", "radial_grad"]
